...
class GeminiService:
    ...
    def generate_virtual_tryon_simple(
        ...
        prompt_parts = [
            "💇 **HAIR TRANSFORMATION TASK**",
            "",
            "🎯 **YOUR MISSION:**",
            "Transform Image 1's person's hairstyle to match Image 2's hairstyle.",
            "This is HAIR REPLACEMENT (換髮). You MUST change the hair completely.",
            "",
            "📸 **INPUTS:**",
            "- **Image 1:** Person who needs a new hairstyle. Keep their face/body/clothes/background.",
            "- **Image 2:** Hair reference. Copy this EXACT hairstyle to Image 1's person.",
            "",
            "🔥 **MANDATORY TRANSFORMATION:**",
            "You MUST change Image 1's hair to match Image 2's hair. Even if:",
            "- Short hair → Long hair (or vice versa)",
            "- Straight hair → Curly hair (or vice versa)",
            "- Black hair → Colored hair (or vice versa)",
            "- Simple style → Complex style (or vice versa)",
            "",
            "⚠️ DO NOT be conservative. DO NOT keep the original hair.",
            "The user wants a COMPLETE hair transformation.",
            "",
            "📤 **OUTPUT MUST BE:**",
            "✅ ONE person (Image 1's person)",
            "✅ NEW hairstyle (Image 2's hairstyle - MUST be visibly different)",
            "✅ Same face, body, clothes, background (from Image 1)",
            "❌ NOT two people or composite",
            "❌ NOT the original hairstyle (Image 1's hair)",
        ]
        ...
        prompt_parts.extend([
            ...
            "",
            "**STEP 1: OBSERVE Image 2's hairstyle carefully**",
            "Examine Image 2's person's hair in detail:",
            "• Length: How long is it? (covers ears? reaches shoulders? past shoulders?)",
            "• Color: What exact color/shade? (black, brown, blonde, highlights?)",
            "• Texture: What type? (straight, wavy, curly, coily?)",
            "• Volume: How much volume? (flat, medium, voluminous, puffy?)",
            "• Style: How is it styled? (parted? bangs? swept? layered?)",
            "• Cut: What's the cut shape? (bob, pixie, layers, fade, undercut?)",
            "",
            "**STEP 2: TRANSFORM Image 1's hair completely**",
            "Replace Image 1's existing hair with NEW hair that has:",
            "✓ SAME length as Image 2 (even if drastically different)",
            "✓ SAME color as Image 2 (even if completely different)",
            "✓ SAME texture as Image 2 (straight→curly or curly→straight is OK)",
            "✓ SAME volume as Image 2",
            "✓ SAME style as Image 2",
            "✓ SAME cut shape as Image 2",
            "",
            "**OVERRIDE THE ORIGINAL HAIR:**",
            "Completely replace Image 1's original hair. Do NOT preserve it.",
            "• Mask/remove the old hair; the NEW hair must fully occlude it",
            "• Redraw the hairline to match Image 2 (including bangs/forehead coverage)",
            "• If Image 2 covers ears/cheeks/neck/shoulders, the output must cover the same areas",
            "• Extend the silhouette outward if needed (it's OK to add new pixels beyond original hair)",
            "• If pose or angle differs, approximate logically but KEEP length/part/volume from Image 2",
            "",
            "**DIFFERENCE ENFORCEMENT (relative to Image 1):**",
            "If Image 2 differs from Image 1 on any of these, you MUST change them:",
            "• Length landmark (above ears / at ears / jaw / shoulders / past shoulders)",
            "• Parting direction and presence of bangs/fringe",
            "• Texture class (straight / wavy / curly / coily)",
            "• Volume level (flat / medium / voluminous / puffy)",
            "At least THREE of the above must visibly differ from Image 1 when they differ in Image 2.",
            "",
            "🔥 BE BOLD: If Image 2 has long hair and Image 1 has short hair,",
            "you MUST generate long hair. Don't be timid. Transform it completely.",
            "",
            "**STEP 3: Keep Image 1's identity**",
            "While transforming hair, preserve:",
            "✓ Face (Image 1's face)",
            "✓ Body (Image 1's pose, position)",
            "✓ Clothes (Image 1's outfit)",
            "✓ Background (Image 1's scene)",
            "",
            "🚫 **FAILURES:**",
            "❌ FAILURE: Keeping Image 1's original hair (user wants transformation!)",
            "❌ FAILURE: Making only minor changes (user wants complete transformation!)",
            "❌ FAILURE: Being conservative (BE BOLD!)",
            "❌ FAILURE: Adding Image 2's person (only copy the HAIR)",
            "❌ FAILURE: Creating two-person composite",
            "",
            "✅ **SUCCESS:**",
            "✅ Image 1's person with Image 2's hairstyle (visibly different hair)",
            "✅ Hair transformation is obvious and matches Image 2",
            "✅ Only ONE person in output",
        ])
        ...
        prompt_parts.extend([
            ...
            "",
            "1️⃣ **Did I transform the hair?**",
            "   ✅ YES: Hair looks completely different (length, color, texture, style match Image 2)",
            "   ❌ NO: Hair looks the same as Image 1 → FAIL, go back and transform it",
            "",
            "2️⃣ **Whose hairstyle is in my output?**",
            "   ✅ CORRECT: Image 2's hairstyle (the reference)",
            "   ❌ WRONG: Image 1's hairstyle (the original) → FAIL",
            "",
            "3️⃣ **Is the hair change obvious?**",
            "   ✅ YES: Anyone can see the hair is different",
            "   ❌ NO: Hair looks almost the same → FAIL, be bolder",
            "",
            "4️⃣ **How many people in output?**",
            "   ✅ ONE person (Image 1's person)",
            "   ❌ Two people or composite → FAIL",
            "",
            "5️⃣ **Whose face/body in output?**",
            "   ✅ Image 1's face and body",
            "   ❌ Image 2's face or mixed → FAIL",
            "",
            "⚠️ **MOST COMMON MISTAKE: Being too conservative with hair changes.**",
            "⚠️ **Remember: The user WANTS a dramatic transformation. BE BOLD.**",
            "⚠️ **If hair looks almost the same, you FAILED. Transform it completely.**",
        ])
