...
class GeminiService:
    ...
    def generate_virtual_tryon_simple(
        ...
        # --- Prompt for GEMINI IMAGE GENERATION (hair replacement) ---
        prompt_parts = [
            "TASK: Replace the hairstyle of the person in Image 1 with the hairstyle from Image 2.",
            "",
            "⚠️ CRITICAL: Output must show EXACTLY ONE PERSON.",
            "⚠️ DO NOT put two people in the photo.",
            "⚠️ DO NOT show Image 2's person.",
            "⚠️ ONLY show Image 1's person (with a different hairstyle).",
            "",
            "INSTRUCTIONS:",
            "1. Look at Image 1 - This is the person you will generate",
            "2. Look at Image 2 - This is ONLY for hairstyle reference (ignore the person)",
            "3. Generate Image 1's person with Image 2's hairstyle",
            "",
            "FROM IMAGE 1 (keep everything):",
            "✓ The person's face",
            "✓ The person's body and pose",
            "✓ The person's clothing",
            "✓ The background",
            "",
            "FROM IMAGE 2 (take ONLY the hairstyle):",
            "✓ Hair length",
            "✓ Hair color",
            "✓ Hair texture",
            "✓ Hair volume",
            "✓ Hair styling",
            "❌ DO NOT take the person from Image 2",
            "",
            "FORBIDDEN:",
            "❌ Two people in the photo",
            "❌ Image 2's person appearing in the output",
        ...
        prompt_parts.extend([
            "",
            "CORRECT OUTPUT:",
            "✓ Exactly ONE person (Image 1's person)",
            "✓ Same face from Image 1",
            "✓ Same body and pose from Image 1",
            "✓ Same clothes from Image 1",
            "✓ Same background from Image 1",
            "✓ NEW hairstyle from Image 2",
            "",
            "WRONG OUTPUT (DO NOT GENERATE):",
            "❌ Two people sitting together",
            "❌ Image 1's person + Image 2's person",
            "❌ Two faces in the photo",
            "❌ Side-by-side people",
            "",
            "QUALITY REQUIREMENTS:",
            "- Natural-looking hairstyle (not a wig)",
            "- Hair naturally attached to the person's head",
            "- Professional salon photo quality",
        ])
        ...
        prompt_parts.extend([
            "",
            "FINAL REMINDER:",
            "You are generating ONE PERSON ONLY.",
            "This person is from Image 1.",
            "This person's hair is styled like Image 2's hair.",
            "DO NOT include Image 2's person in the output.",
            "DO NOT create two people.",
            "Count the faces in your output - there must be EXACTLY ONE FACE.",
        ])
